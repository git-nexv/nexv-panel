...
const FA = {
  ...
  'Wrong username or password.': 'نام کاربری یا گذرواژه اشتباه است.',
  'that username is taken': 'این نام کاربری گرفته شده است',
  'this panel already has an account - sign in instead': 'این پنل از قبل حساب دارد — وارد شوید',
  'this address is not open': 'این آدرس باز نیست',
  'username and password are required': 'نام کاربری و گذرواژه لازم است',
  'invalid credentials': 'اطلاعات ورود نادرست است',
  'Sign-in failed.': 'ورود ناموفق بود.',
  'Could not reach the server.': 'نتوانست به سرور برسد.',
  'The server did not respond. Try again.': 'سرور جواب نداد. دوباره تلاش کنید.',
  'Opening panel…': 'در حال باز کردن پنل…',
  'Signed in, but the panel page did not load. Check "nexv logs" on the server.':
    'وارد شدید، ولی صفحه پنل بالا نیامد. روی سرور «nexv logs» را ببینید.',
  ...
  /* the looks on offer, and what each one is */
  'Theme': 'تم',
  'Liquid glass': 'شیشه‌ای',
  'Layered glass over one drifting light.': 'لایه‌های شیشه‌ای روی یک نور متحرک.',
  'Simple': 'ساده',
  'Solid panels, drawn borders, a background that holds still.': 'باکس‌های توپر، خطوط مشخص، و پس‌زمینه‌ای بی‌حرکت.',
  'Midnight': 'نیمه‌شب',
  'Indigo ground with a violet accent.': 'زمینه‌ی نیلی با تأکید بنفش.',
  'Aurora': 'شفق',
  'Deep teal ground with a mint accent.': 'زمینه‌ی فیروزه‌ای تیره با تأکید نعنایی.',
  'Sunset': 'غروب',
  'Warm clay ground with an amber accent.': 'زمینه‌ی گرم خاکی با تأکید کهربایی.',
  'Mono': 'تک‌رنگ',
  'No colour at all, and the hairlines turned up.': 'بدون هیچ رنگی، با خطوط پررنگ‌تر.',
  'The look is kept in this browser, so each person signing in can have their own. Light and dark stay on the switch up top.':
